            ...
            {expandedInactive && (
              ...
              >
                <div
                  ...
                  onClick={() => {
                    if (onNavigate) onNavigate(`/${expandedInactive.name}`)
                  }}
                  onKeyDown={(e) => {
                    if (e.key === 'Enter' || e.key === ' ') {
                      e.preventDefault()
              ...
              return (
                ...
                >
                  <div
                    ...
                    onClick={() => {
                      if (onNavigate) onNavigate(`/${category.name}`)
                    }}
                    onKeyDown={(e) => {
                      if (e.key === 'Enter' || e.key === ' ') {
                        e.preventDefault()
    ...
    >
      ...
      {showScaleHint && letterPosition && (
        <div
          style={{
            position: 'fixed',
            left: `${getHintPosition(knobX, knobY, isMobile ? 140 : 80).x}px`,
            top: `${getHintPosition(knobX, knobY, isMobile ? 140 : 80).y}px`,
            pointerEvents: 'none',
            backgroundColor: '#000',
            border: '1px solid #000',
            borderRadius: '6px',
