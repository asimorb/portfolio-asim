...
// ========================================
const LeftPanel = ({ readingMode, shuffleLetters, toggleReadingMode, showButtonTooltip, hideButtonTooltip }) => {
  return (
    <>
      {/* Vertical dotted line */}
      <div 
...
const LetterStack = ({
  ...
  return (
    <>
      ...
      {readingMode ? (() => {
        const gridPositions = [
          { top: window.innerHeight * 0.37, left: window.innerWidth * 0.82 },   // ayin
          { top: window.innerHeight * 0.15, left: window.innerWidth * 0.71 },   // mim
          { top: window.innerHeight * 0.15, left: window.innerWidth * 0.82 },   // sad
          { top: window.innerHeight * 0.15, left: window.innerWidth * 0.59 }   //alif
        ]
      ...
      : (hoveredLetter && tooltipStyle?.style && (
        <div
          className="fixed z-50 pointer-events-none overflow-hidden"
          style={{
            ...tooltipStyle.style,
