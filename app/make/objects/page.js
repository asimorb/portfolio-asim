  ...
  return (
    ...
    >
      ...
      <TopBarTransform
        ...
        analyticsText="OBJECTS OVERVIEW"
      ...
      <div style={{ padding: '120px 140px 100px 120px', opacity: overlayProject ? 0 : 1, transition: 'opacity 240ms ease' }}>
        <div style={{ display: 'grid', gridTemplateColumns: 'minmax(220px, 320px) 1fr', columnGap: '80px', rowGap: '32px', alignItems: 'start' }}>
          <div style={{ fontFamily: 'var(--font-karla)', fontSize: '32px', fontWeight: 200, lineHeight: '32px', color: '#000', marginTop: '250px', maxWidth: '800px' }}>
          ...
          <div style={{
            ...
            {objectsProjects.map((project, idx) => {
        ...
        >
          ...
          >
            <div>
              ...
              <div style={{ fontSize: '24px', fontWeight: 300, letterSpacing: '-0.03em', marginBottom: '-1px'}}>{overlayProject.title}</div>
            </div>
            <div>
              ...
              <div style={{ fontSize: '24px', fontWeight: 300, letterSpacing: '-0.03em', marginBottom: '-1px' }}>{overlayProject.client}</div>
            </div>
            <div>
              <div style={{ fontSize: '12px', fontWeight: 700, textTransform: 'lowercase', letterSpacing: '0.001em', opacity: 1, marginBottom: '-5px' }}>type</div>
              <div style={{ fontSize: '24px', fontWeight: 300, letterSpacing: '-0.03em', marginBottom: '-1px' }}>{overlayProject.type}</div>
            </div>
            <div>
              ...
              <div style={{ fontSize: '24px', fontWeight: 300, letterSpacing: '-0.03em', marginBottom: '-1px' }}>{overlayProject.status}</div>
            </div>
            <div>
              ...
              <div style={{ fontSize: '24px', fontWeight: 300, letterSpacing: '-0.03em', lineHeight: '24px', maxWidth: '320px', marginBottom: '-10px' }}>{overlayProject.notes}</div>
            </div>
